...
var JourneyService = (function () {
    ...
    JourneyService.prototype.getJourneysBySupplier = function (supplierId) {
        this.headers.set('X-TOKEN', this.loginService.getSessionId());
    ...
    JourneyService.prototype.getVersionsBySupplierAndJourney = function (supplierId, journeyId) {
        this.headers.set('X-TOKEN', this.loginService.getSessionId());
